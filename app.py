...
"""
LOCATIONS = ['California', 'Texas', 'Florida', 'New York', 'Pennsylvania',
       'Illinois', 'Ohio', 'Georgia', 'North Carolina', 'Michigan']
"""


LOCATIONS = ['London', 'Wales', 'Oxford', 'Scotlad', 'Bolton',
       'Ireland', 'Dublin', 'Manchester', 'Belfast', 'Kent']
NOUNS = ['Vicar', 'Influencer', 'Shovel', 'Paleo Diet', 'Doctor', 'Parent',
      'Cat', 'Dog', 'Chicken', 'Robot', 'Video Game', 'Avocado',
      'Plastic Straw','Serial Killer', 'Telephone Psychic']
PLACES = ['House', 'Flat', 'Attic', 'Post Office', 'School', 'Basement',
       'Workplace', 'Church', 'Bunker']
WHEN = ['Soon', '"This winter',  'This Year', 'Later Today', 'RIGHT NOW', 'Next Week']
